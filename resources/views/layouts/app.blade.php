            ...
            <div class="w-70 mr-5">
                <div class="bg-white border-2 border-blue rounded-xl mt-16">
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        ...
                        <div>
                            <select name="category_add" id="category" class="w-full bg-gray-100 text-sm rounded-xl px-4 py-2 border-none">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl placeholde-gray-900 text-sm px-4 py-2 border-none" placeholder="Describe your idea"></textarea>
                        </div>
                        <div class="flex items-center justify-between space-x-3">
                            ...
                            <button
                                type="submit"
                                class="w-1/2 flex items-center justify-center h-11 text-xs w-32 bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                            >
